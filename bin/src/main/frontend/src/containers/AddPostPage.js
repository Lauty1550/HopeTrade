  ...
  const handleChange = (e) => {
    ...
    switch (e.target.id) {
      case "titulo":
        ...
        break;
      case "descripcion":
        tempForm = { ...tempForm, descripcion: e.target.value };
        break;
      case "categoria":
        tempForm = { ...tempForm, categoria: e.target.value };
        break;
      case "imagen":
        tempForm = { ...tempForm, imagen: e.target.value };
        break;
      default:
        break;
    }
        ...
        <Item>
          <FormControl>
            ...
            <FormHelperText id="descripcion-text">
              Describa el producto publicado
            </FormHelperText>
          </FormControl>
        </Item>
        <Item>
          <FormControl>
            ...
            <FormHelperText id="categoria-text">
              Seleccione la categoría del producto publicado
            </FormHelperText>
          </FormControl>
        </Item>
        <Item>
          <FormControl>
            ...
            />
            <FormHelperText id="descripcion-text">
              Agregue una foto del producto publicado
            </FormHelperText>
          </FormControl>
        </Item>
        <Item>
